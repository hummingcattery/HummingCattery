...
<template>
    ...
    <div class="content-container">
        ...
        <p>
            Tavoitteenani on kasvattaa terveitä, kauniita, hyväluonteisia birmoja joilla on se oikea "birmalook", myös birmojen geenipoolin laajentaminen on tärkeä arvo kasvatustyössä. Vuonna 2023
        ...
        <div class="image-container">
            <img class="img-fluid smaller-img d-block mx-auto" :src="breederImg" alt="Jenni">
        </div>
    </div>
